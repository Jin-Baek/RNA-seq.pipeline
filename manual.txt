...
All folders are created at the location of the main.R file.
All R files must be located on the same path.
Trimming, alignment, quantification processes are perform based on samples which located in /samples path & All samples should be same end mode
...
Rscript main.R -df http://ftp.ensembl.org/pub/release-105/fasta/mus_musculus/dna/Mus_musculus.GRCm39.dna.toplevel.fa.gz http://ftp.ensembl.org/pub/release-105/gtf/mus_musculus/us_musculus.GRCm39.105.gtf.gz -Ptrim /program/Trimmomatic/trimmomatic-0.39.jar -Padapt /program/Trimmomatic/adapters/TruSeq3-PE.fa:2:30:10:2:True -em PE -ref Mus_musculus.GRCm39.dna.toplevel.fa -i Mus_musculus_IndexFile -an Mus_musculus.GRCm39.105.gtf.gz -sm samples.txt -dump /disk4/download_via_parallel.sh
